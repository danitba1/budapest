...
--   GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.packing_categories, public.packing_items, public.trip_day_meals TO my_app_user;
...
--   GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.trip_day_meals TO my_app_user;
